...
**We can see that the actors with the highest average box office revenue are Vera Farminga and Patrick Wilson. This makes sense since James Wan is the director associated with the second highest average box office revenue for horror movie in our dataset, and Vera Farminga and Patrick Wilson are the stars of the very popular Conjuring series.**
...
This insight is still useful just not for our putpose. We have come to see that movies that earn higher revenue tend to attract more votes, which reflects audience engagement and popularity, we were lookign at popular horror movie on IMDB after all. However, votes cannot be used to reliably predict revenue.
...
Attempting to build a regression model with metascores as the predictor fails though they a not insignificant, postive correalation because the underlying relationship is reversed: box office revenue influences the number of metascore ratings a movie receives, and not the other way around. This violates the assumptions of a predictive model.
